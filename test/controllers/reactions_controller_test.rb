...
class ReactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reaction" do
    assert_difference('Reaction.count') do
      post reactions_url, params: { reaction: { headline_id: @reaction.headline_id, url: @reaction.url, user_id: @reaction.user_id } }, as: :json
    end
  ...
  test "should update reaction" do
    patch reaction_url(@reaction), params: { reaction: { headline_id: @reaction.headline_id, url: @reaction.url, user_id: @reaction.user_id } }, as: :json
    assert_response 200
  end
